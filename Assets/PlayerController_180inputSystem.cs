...
public class PlayerController_180inputSystem : MonoBehaviour, PlayerInputAsset.IPlayerActions, IDamagable, IBounce
{
    public enum State
    {
        normal,
    ...
    public PlayerInputAsset _playerInputAsset;

    //basic state
    public static PlayerController_180inputSystem _instance;
    ...
    private void Awake()
    {
        _playerInputAsset.Player.SetCallbacks(this);
    }
